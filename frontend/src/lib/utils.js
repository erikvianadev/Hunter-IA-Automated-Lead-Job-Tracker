...
const DIRECT_LABELS = {
  ...
  issue: "Atenção",
  document_not_resume_like: "Nao parece curriculo",
  insufficient_resume_signals: "Faltam sinais de curriculo",
  blocked_for_low_resume_confidence: "Baixa confianca de curriculo",
